...
const Elon2 = () => {
  ...
  useEffect(() => {
    ...
    const getElon = async() => {
      await axios.get(`https://djangoburhon.pythonanywhere.com/api/new/?search=${els}`)
        .then(response => {
        ...
        <div className='mt-28 w-100 position-absolute' style={{minHeight: "800px"}}>
            <div className='w-100 xl:px-24 lg:px-14 sm:px-12 xs:px-4 py-10 mt-5 mb-5'>
              <div className='w-100 p-2 justify-between'>
                  ...
                  <img className='divw-49 xs:w-full mr-12 mb-7 mt-2 float-start' src={elon? elon[0].image1 : null} alt="" />
